...
#define EEPROM_CS_HIGH()	HAL_GPIO_WritePin(SPI3_NSS_GPIO_Port, SPI3_NSS_Pin, GPIO_PIN_SET)
#define EEPROM_CS_LOW()		HAL_GPIO_WritePin(SPI3_NSS_GPIO_Port, SPI3_NSS_Pin, GPIO_PIN_RESET)
#define EEPROM_H_HIGH()		HAL_GPIO_WritePin(SPI3_H_GPIO_Port, SPI3_H_Pin, GPIO_PIN_SET)
#define EEPROM_H_LOW()		HAL_GPIO_WritePin(SPI3_H_GPIO_Port, SPI3_H_Pin, GPIO_PIN_RESET)
#define EEPROM_W_HIGH()		HAL_GPIO_WritePin(SPI3_W_GPIO_Port, SPI3_W_Pin, GPIO_PIN_SET)
#define EEPROM_W_LOW()		HAL_GPIO_WritePin(SPI3_W_GPIO_Port, SPI3_W_Pin, GPIO_PIN_RESET)
